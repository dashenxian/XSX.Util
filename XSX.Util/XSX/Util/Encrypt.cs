...
namespace XSX.Util
{
    ...
    public static class Encrypt
    {
        ...
        /// </summary>
        public static string DefaultEncryptKey = "XSX.Util".MDString2();
        public static string DefaultEncryptIv = "XSX.Util".MDString2();
        /// <summary>
        /// 使用默认加密
        /// </summary>
        ...
        public static string DesEncrypt(this string strText)
        {
            try
            {
                return DesEncrypt(strText, DefaultEncryptKey, DefaultEncryptIv);
            }
            catch
            {
                return "";
        ...
        public static string DesEncrypt(this string strText, string strEncrKey, string iv)
        {
            ...
            if (iv.Length < 8)
            {
                throw new Exception("iv长度无效，密钥必须是8位！");
            }
        ...
        private static readonly string Default_AES_Key = "XSX.Util".MDString2();

        private static readonly string Default_AES_Iv = "XSX.Util".MDString2();
        ...
        {
            return AESEncrypt(encryptString, encryptKey, Default_AES_Iv);
        }
        /// <summary>
        /// 对称加密算法AES RijndaelManaged加密(RijndaelManaged（AES）算法是块式加密算法)
        /// </summary>
        ...
        /// <param name="encryptKey">加密密钥，须半角字符</param>
        /// <returns>加密结果字符串</returns>
        public static string AESEncryptHex(this string encryptString, string encryptKey, string iv)
        {
            //encryptKey = GetSubString(encryptKey, 32, "");
            //encryptKey = encryptKey.PadRight(32, ' ');
            //iv = GetSubString(iv, 32, "");
            ...
            byte[] inputData = Encoding.UTF8.GetBytes(encryptString);
            byte[] encryptedData = rijndaelEncrypt.TransformFinalBlock(inputData, 0, inputData.Length);
            return StringExtensions.ByteArrayToHexString(encryptedData);
        }
        /// <summary>
        ...
        {
            return AESDecrypt(decryptString, Default_AES_Key, Default_AES_Iv);
        }
        ...
        public static void AESDecryptFile(this FileStream input, string outputPath)
        {
            ...
            CryptoStream defr = AESDecryptStream(input, Default_AES_Key, Default_AES_Iv);
